...
def print_live_uptime(start_time, downtime, sent_packets, lost_packets):
...
def main():
    ...
    uptime_thread = threading.Thread(target=print_live_uptime, args=(start_time, failed_checks * interval, sent_packets, lost_packets))
    uptime_thread.start()
